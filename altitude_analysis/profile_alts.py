...
pth = '../0_Data/3_SATELLITE_data/1_GOES/Humedad_perfil_vertical/Ancohuma_stations.csv'
...
ax.scatter(a.T[:,583], pressures)
ax.invert_yaxis()
ax.axhline(alt_to_press(5135), ls='dashed', label = 'DEM', c = 'red')
